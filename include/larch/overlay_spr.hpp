...
inline phylo_dag apply_spr_as_fragment(phylo_dag& tree, spr_move const& move) {
  ...
  // Extract full tree from UA's child (not just the affected subtree).
  // This allows Fitch improvements to propagate all the way to the root.
  ...
  // No parent_cg anchoring -- free to find globally optimal assignment.
