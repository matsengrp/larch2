...
| 7. Make lazy charts scalable and adaptive | implementation in progress | Packed deterministic grouping and both named fixtures are implemented at `c08602b`; dependency wavefronts, transient admission, auto policy, sanitizers, and sealed performance gates remain pending |
