...
| 7. Make lazy charts scalable and adaptive | implementation in progress | Packed deterministic grouping, both named fixtures, and dependency-level inside/outside wavefronts are implemented through `a8abc49`; transient admission, within-clade staging/profile decision, auto policy, sanitizers, and sealed performance gates remain pending |
