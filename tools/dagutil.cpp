...
static void run_chart_spr_search_diagnostic(
  ...
  out << "  multifurcation_productions_scored: "
      << search.summary.multifurcation_productions_scored << "\n";
...
static void run_chart_spr_helper_benchmark(
  ...
  counters.multifurcation_productions_scored +=
      composite.multifurcation_productions_scored;
  out << "  baseline_multifurcation_productions_scored: "
      << composite.multifurcation_productions_scored << "\n";
...
int main(int argc, char** argv) try {
  ...
  if (a.chart_composite_score) {
    ...
    std::cout << "  weighted_lower_bound: "
              << composite.weighted_lower_bound << "\n";
    std::cout << "  multifurcation_productions_scored: "
              << composite.multifurcation_productions_scored << "\n";
    std::cout << "  score_ua_edge: "
              << (a.chart_score_ua_edge ? "true" : "false") << "\n";
    if (a.wric_lazy_chart) {
